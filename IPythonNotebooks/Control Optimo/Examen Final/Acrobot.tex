...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k}{def} \PY{n+nf}{f}\PY{p}{(}\PY{n}{estado}\PY{p}{,} \PY{n}{tiempo}\PY{p}{,} \PY{n}{K}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{n}{G} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{graficatemporal}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{./imagenes/trayectoriasacrobotlibre.png}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{ts}\PY{p}{,} \PY{p}{[}\PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}q\PYZus{}1(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}q\PYZus{}2(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}

\begin{center}
\includegraphics[width=\linewidth]{./imagenes/trayectoriasacrobotlibre.png}
\end{center}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{graficaxy}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{./imagenes/xyacrobotlibre.png}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{p}{[}\PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}q\PYZus{}1(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}q\PYZus{}2(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}

\begin{center}
\includegraphics[width=0.5\linewidth]{./imagenes/xyacrobotlibre.png}
\end{center}
...
\frac{m_1 l_1^2 + m_2 \left( l_1 + l_2\right)^2}{m_1 m_2 l_1^2 l_2^2}
\end{pmatrix}
\]
...
{\color{incolor}In [{\color{incolor}12}]:} \PY{k}{def} \PY{n+nf}{f\PYZus{}lineal}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{K}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    y el tiempo \PYZdq{}t\PYZdq{}, devuelve la derivada en el tiempo \PYZdq{}t\PYZdq{}. Para el caso del acrobot,}
         \PY{l+s+sd}{    es invariante en el tiempo, por lo que es equivalente a ẋ = f(x).}
         ...
         \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
             ...
             \PY{n}{B} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}
                         ...
                         \PY{p}{[}\PY{o}{\PYZhy{}}\PY{p}{(}\PY{n}{l1} \PY{o}{+} \PY{n}{l2}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{m1}\PY{o}{*}\PY{n}{l1}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{l2}\PY{p}{)}\PY{p}{]}\PY{p}{,}
                         \PY{p}{[}\PY{p}{(}\PY{n}{m1}\PY{o}{*}\PY{n}{l1}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{+} \PY{n}{m2}\PY{o}{*}\PY{p}{(}\PY{n}{l1}\PY{o}{+}\PY{n}{l2}\PY{p}{)}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{n}{m1}\PY{o}{*}\PY{n}{m2}\PY{o}{*}\PY{n}{l1}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{l2}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{]}\PY{p}{]}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{graficatemporal}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{./imagenes/trayectoriasacrobotlineallibre.png}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{xl}\PY{p}{,} \PY{n}{ts}\PY{p}{,} \PY{p}{[}\PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{xi\PYZus{}1(t) + }\PY{l+s}{\PYZbs{}}\PY{l+s}{frac\PYZob{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{tau\PYZcb{}\PYZob{}4\PYZcb{}\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{xi\PYZus{}2(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}

\begin{center}
\includegraphics[width=\linewidth]{./imagenes/trayectoriasacrobotlineallibre.png}
\end{center}
        
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{graficaxy}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{./imagenes/xyacrobotlineallibre.png}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{xl}\PY{p}{,} \PY{p}{[}\PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{xi\PYZus{}1(t) + }\PY{l+s}{\PYZbs{}}\PY{l+s}{frac\PYZob{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{tau\PYZcb{}\PYZob{}4\PYZcb{}\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{xi\PYZus{}2(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}

\begin{center}
\includegraphics[width=0.5\linewidth]{./imagenes/xyacrobotlineallibre.png}
\end{center}
        
\begin{center}
\includegraphics[width=0.5\linewidth]{./imagenes/xyacrobotlinealynolineallibres.png}
\end{center}
        
    Aqui podemos ver como el sistema linealizado diverge rapidamente del
sistema original, por lo que podemos asumir que este modelo linealizado
...
{\color{incolor}In [{\color{incolor}19}]:} \PY{n}{m1} \PY{o}{=} \PY{l+m+mf}{0.2} \PY{c}{\PYZsh{} kg}
         ...
         \PY{n}{Q} \PY{o}{=} \PY{n}{matrix}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}20}]:} array([[-824.83578712, -227.19136829, -242.11329833,  -69.17052269]])
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{ts} \PY{o}{=} \PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{500}\PY{p}{)}
         \PY{n}{estado\PYZus{}inicial\PYZus{}lineal} \PY{o}{=} \PY{p}{[}\PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.09}\PY{p}{,} \PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.0}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{graficatemporal}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{./imagenes/trayectoriasacrobotlinealoptimo.png}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{xl}\PY{p}{,} \PY{n}{ts}\PY{p}{,} \PY{p}{[}\PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{xi\PYZus{}1(t) + }\PY{l+s}{\PYZbs{}}\PY{l+s}{frac\PYZob{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{tau\PYZcb{}\PYZob{}4\PYZcb{}\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{xi\PYZus{}2(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}

\begin{center}
\includegraphics[width=\linewidth]{./imagenes/trayectoriasacrobotlinealoptimo.png}
\end{center}
        
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{n}{graficaxy}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{./imagenes/xyacrobotlinealoptimo.png}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{xl}\PY{p}{,} \PY{p}{[}\PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{xi\PYZus{}1(t) + }\PY{l+s}{\PYZbs{}}\PY{l+s}{frac\PYZob{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{tau\PYZcb{}\PYZob{}4\PYZcb{}\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}}\PY{l+s}{\PYZbs{}}\PY{l+s}{xi\PYZus{}2(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}

\begin{center}
\includegraphics[width=0.5\linewidth]{./imagenes/xyacrobotlinealoptimo.png}
\end{center}
...
{\color{incolor}In [{\color{incolor}24}]:} \PY{n}{ts} \PY{o}{=} \PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{500}\PY{p}{)}
         \PY{n}{estado\PYZus{}inicial} \PY{o}{=} \PY{p}{[}\PY{n}{τ}\PY{o}{/}\PY{l+m+mi}{4}\PY{p}{,} \PY{l+m+mf}{0.011}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{n}{graficatemporal}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{./imagenes/trayectoriasacrobotoptimo.png}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{ts}\PY{p}{,} \PY{p}{[}\PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}q\PYZus{}1(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}q\PYZus{}2(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}

\begin{center}
\includegraphics[width=0.9\linewidth]{./imagenes/trayectoriasacrobotoptimo.png}
\end{center}
        
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{graficaxy}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{./imagenes/xyacrobotoptimo.png}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{p}{[}\PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}q\PYZus{}1(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{r\PYZsq{}}\PY{l+s}{\PYZdl{}q\PYZus{}2(t)\PYZdl{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
