...
\chapter{Criterio de Estabilidad de Routh-Hurwitz}
    ...
    \section{Acción Proporcional}
        ...
        \missingfigure{Diagrama de bloques de planta lineal con controlador proporcional.}
...
Por lo que concluimos que la ganancia $k$ debe de seguir: $k>-1$
    ...
    \section{Acción Integral}
        ...
        \missingfigure{Diagrama de bloques de sistema lineal con controlador integral.}
        ...
        \subsection{Error en el estado permanente al escalón unitario}
            ...
            \missingfigure{Diagrama de bloques de sistema de 2º orden con controlador integral.}
