...
%-------------------------------------------------------------------------------
    ...
    \subsection{Homomorfismos de grupo}
        ...
        \begin{ejemplo}
            Sea $G = \mathbbm{R}^+ \setminus \{0\}$, bajo el producto usual y sea $\bar{G} = \mathbbm{R}$ bajo la adición, definimos $\varphi \colon G \to \bar{G}$ como:

            \begin{eqnarray*}
                \varphi \colon \mathbbm{R}^+ \setminus \{0\} & \to & \mathbbm{R} \\
                r & \to & \ln{r}
            \end{eqnarray*}

            Sean $r_1, r_2 \in \mathbbm{R}^+ \setminus \{0\}$ tal que:
